<?php
    ...
    $tipoProductos = $tipoProducto->obtenerTodos();
                            ...
                            <?php
                                if (isset($tipoProductos)) {
                                    foreach ($tipoProductos as $tipoProducto) {
                                        ...
                                        echo "<td class=text-center><a href='tipoproducto-formulario.php?id=" .$tipoProducto->idTipoProducto. "'><i class='fas fa-search'></i></a></td>";
                                        echo "</tr>";
                                    }
                                }
                            ?>
